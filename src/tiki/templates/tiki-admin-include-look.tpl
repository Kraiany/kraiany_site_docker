{* $Id: tiki-admin-include-look.tpl 13911 2008-07-28 01:59:17Z marclaporte $ *}
...
{/if}
	...
	<tr>
		...
		<td ><input type="checkbox" name="feature_siteidentity" {if $prefs.feature_siteidentity eq 'y'}checked="checked"{/if}/> {tr}Required for many of the general layout features{/tr}</td>
	</tr>
       </table>
