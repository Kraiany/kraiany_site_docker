{* $Id: mod-search_box.tpl 12242 2008-03-30 13:22:01Z luciash $ *}
...
{tikimodule title=$tpl_module_title name="search_box" flip=$module_params.flip decorations=$module_params.decorations nobox=$module_params.nobox}
