{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-view_forum_thread.tpl,v 1.45.2.6 2004/06/22 16:52:47 teedog Exp $ *}
...
<table class="forumstart" width=90%>
  <tr>
  	<td colspan=2 class="forumstart_title">
...
<tr>
  ...
  <table width=100%>
  <tr>
  	<td colspan=2 class="forumdiscussion_title">
  		{$comments_coms[ix].title}
  	</td>
  </tr>	
  <tr>
  	<!-- td class="forumdiscussion_title">
